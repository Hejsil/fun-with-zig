...
fn allNoContext(slice: var, predicate: fn (@typeOf(slice[0])) bool) bool {
    for (slice) |item| {
...
pub fn allWithContext(slice: var, context: var, predicate: fn (@typeOf(slice[0]), @typeOf(context)) bool) bool {
    for (slice) |item| {
